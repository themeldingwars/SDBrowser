            ...
            set
            {
                if(isVertical != value)
                {
                    if(value)
                    {
                        ...
                        //moThumbArrowImage.RotateFlip(RotateFlipType.Rotate270FlipNone);
                        moThumbTopImage.RotateFlip(RotateFlipType.Rotate270FlipNone);
                        moThumbTopSpanImage.RotateFlip(RotateFlipType.Rotate270FlipNone);
                        moThumbBottomImage.RotateFlip(RotateFlipType.Rotate270FlipNone);
                        moThumbBottomSpanImage.RotateFlip(RotateFlipType.Rotate270FlipNone);
                        moThumbMiddleImage.RotateFlip(RotateFlipType.Rotate270FlipNone);
                    }
                    else
                    {
